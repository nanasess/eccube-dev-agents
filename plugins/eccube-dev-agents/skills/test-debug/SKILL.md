---
name: test-debug
description: テストでエラーが発生しているが詳細なログが不足している場合に、適切なデバッグ手法を提示します。PHPUnit Webテストを主な対象としていますが、TypeScript/Jest、Python/pytest にも応用可能です。「テストを修正する」「500エラーが出る」「デバッグ方法がわからない」などの場合に使用してください。
---
